...
draft: false
aliases:
  - 2023 Year Obsidian Plugin Awards
tags: 
date created: 2024-01-09 09:30
date modified: 2024-01-09 17:18
date: 2024-01-09 05:19:17
updated: 2024-01-09 05:25:02
up: "[[Obsidian]]"
---
...
## Best New Plugin
 ...
 - [3D Graph](https://github.com/AlexW00/obsidian-3d-graph)) by HananoshikaYomaru
	 - ![[attachments/190087315-8386feee-b861-4520-bb94-19051c7a46c4.gif]]
	 - 安装后又卸载了，比较吃机器性能。我比较喜欢这种 3D 的视图，视觉化的呈现了 `第二大脑🧠` 的这个概念。
 - [better-search-views](https://github.com/ivan-lednev/better-search-views)by ivan-lednev
	 - ![[attachments/Pasted image 20240109095002.png]]
 ...
 - [Chem](https://github.com/Acylation/obsidian-chem) by Acylation
	 ...
	 - > **Chem** 是一个旨在提升化学相关笔记记录体验的 [Obsidian.md](https://obsidian.md/) 插件。目前，本插件能够将您笔记中的 SMILES 字符串渲染为化学结构式。（基于 [Smiles Drawer](https://github.com/reymond-group/smilesDrawer)） ![[Pasted image 20240109100921.png]]

 - [Clipper](https://github.com/jgchristopher/obsidian-clipper) by jgchristopher
	 - 一个浏览器页面剪切后保存到 Obsidian 中的插件。看了官方视频演示，我有一点想尝试一下。
	 - 对于这些剪切插件来说，我最大的痛点其实是能直接在页面上画线记录。然后自动保存整个页面。这一切应该是自然发生的，但是目前所有的剪切插件都需要自己手动保存。
	 - 目前唯一满足需求的就是简悦，但无奈的是简悦的产品设计太复杂了，文档结构乱七八糟的，根本谈不上好用。只能勉强用着官方自己提供的 Obsidian 模板。
 - [Copilot](https://github.com/logancyang/obsidian-copilot)Obsidian by logancyang
	 - 这种 GPT 套壳应用今年特别多，一开始我还觉得挺新奇的，越往后越觉得这种插件非常不适合在笔记中使用。
	 - 不记得在哪看到一个博主说的，阅读文本最大意义就是提炼总结，但如果总结文本本都让 GPT 代劳了，阅读又有多大的意义呢？
 - [Easy Bake](https://github.com/mgmeyers/obsidian-easy-bake)by mgmeyers
	 - 这个插件主要作用是把 Obsidian 的内部连接引用的文件内容直接展示出来。
	 - 在汇总长笔记时还是挺有用的，比如把本周所有的日记都打印在一个文件中。免去复制黏贴的过程。
 - [File Color](https://github.com/ecustic/obsidian-file-color) by ecustic
	 - UI 美化插件，可以给左侧文件列表的文件添加颜色，也可以修改 css 增加 icon。
	 - 对我来说没用。
 - Folder Notes by LostPaul
	 - 对于按照文件夹归类的笔记结构来说，还算是比较方便的插件。但千万别点这个按钮 ![[Screenshot2024-01-09 11.11.27.png]]。
 - [Geocoding Properties](https://github.com/jose-elias-alvarez/obsidian-geocoding-properties) by jose-elias-alvarez
